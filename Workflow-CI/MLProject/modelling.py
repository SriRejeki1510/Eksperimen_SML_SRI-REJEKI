import setuptools  # Import setuptools dulu untuk hindari konflik distutils
import mlflow
import mlflow.sklearn

# Aktifkan autologging sebelum import sklearn
...
# Isi NaN di fitur dengan rata-rata
...
# Hapus baris dengan NaN di label
initial_rows = len(df)
...
# Training model (tanpa mlflow.start_run(), biarkan autolog yang kelola run)
...
# Log metric manual (optional, autolog juga sudah otomatis log)
